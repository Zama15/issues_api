...
export async function seedUsers(prisma, userTypes) {
  ...
  const adminUser = await prisma.users.create({
    data: {
      ...
      sGender: "F",
      sInstitutionalEmail: "alice.admin@ucol.mx",
  ...
  const professorUser = await prisma.users.create({
    data: {
      ...
      sPasswordUser: "password123",
      sGender: "M",
      sInstitutionalEmail: "bob.prof@ucol.mx",
  ...
  const tutorUser = await prisma.users.create({
    data: {
      ...
      sPasswordUser: "password123",
      sGender: "M",
      sInstitutionalEmail: "carlos.tutor@ucol.mx",
  ...
  const studentUser = await prisma.users.create({
    data: {
      ...
      sPasswordUser: "password123",
      sGender: "F",
      sInstitutionalEmail: "diana.student@ucol.mx",
